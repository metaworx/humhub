...
class EventWithTypedValue extends Event
{
    ...
    {
        $class = Helpers::checkClassType($value, $type, false);
    ...
    {
        $float = Helpers::checkFloat($value, $options);
    ...
    {
        $bool = Helpers::checkBool($value, $options);
    ...
    {
        $int = Helpers::checkInt($value, $options);
    ...
    {
        $string = Helpers::checkString($value, $options);
